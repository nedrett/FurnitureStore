...
{
    public partial class SofaEntityModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sofas_AspNetUsers_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sofas_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sofas_BuyerId",
                table: "Sofas",
                column: "BuyerId");

            migrationBuilder.CreateIndex(
                name: "IX_Sofas_CreatorId",
                table: "Sofas",
                column: "CreatorId");
        }
